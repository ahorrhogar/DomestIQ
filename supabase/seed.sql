...
insert into public.offers (id, product_id, merchant_id, price, old_price, url, stock, updated_at) values
  ('90000000-0000-4000-8000-000000000001', '80000000-0000-4000-8000-000000000001', '70000000-0000-4000-8000-000000000001', 449.00, 599.00, 'https://amazon.es/dp/homara-sofa-001', true, now() - interval '4 hours'),
  ('90000000-0000-4000-8000-000000000002', '80000000-0000-4000-8000-000000000001', '70000000-0000-4000-8000-000000000002', 469.00, 619.00, 'https://ikea.com/es/p/homara-sofa-001', true, now() - interval '8 hours'),
  ('90000000-0000-4000-8000-000000000003', '80000000-0000-4000-8000-000000000002', '70000000-0000-4000-8000-000000000002', 389.00, 489.00, 'https://ikea.com/es/p/homara-mesa-002', true, now() - interval '5 hours'),
  ('90000000-0000-4000-8000-000000000004', '80000000-0000-4000-8000-000000000002', '70000000-0000-4000-8000-000000000003', 405.00, 499.00, 'https://leroymerlin.es/homara-mesa-002', true, now() - interval '7 hours'),
  ('90000000-0000-4000-8000-000000000005', '80000000-0000-4000-8000-000000000003', '70000000-0000-4000-8000-000000000001', 59.90, 89.90, 'https://amazon.es/dp/homara-lampara-003', true, now() - interval '3 hours'),
  ('90000000-0000-4000-8000-000000000006', '80000000-0000-4000-8000-000000000003', '70000000-0000-4000-8000-000000000005', 64.90, 99.90, 'https://carrefour.es/homara-lampara-003', true, now() - interval '11 hours'),
  ('90000000-0000-4000-8000-000000000007', '80000000-0000-4000-8000-000000000004', '70000000-0000-4000-8000-000000000001', 24.90, 39.90, 'https://amazon.es/dp/homara-sarten-004', true, now() - interval '6 hours'),
  ('90000000-0000-4000-8000-000000000008', '80000000-0000-4000-8000-000000000004', '70000000-0000-4000-8000-000000000005', 27.50, 39.90, 'https://carrefour.es/homara-sarten-004', true, now() - interval '12 hours'),
  ('90000000-0000-4000-8000-000000000009', '80000000-0000-4000-8000-000000000005', '70000000-0000-4000-8000-000000000001', 149.00, 229.00, 'https://amazon.es/dp/homara-ollas-005', true, now() - interval '5 hours'),
  ('90000000-0000-4000-8000-000000000010', '80000000-0000-4000-8000-000000000005', '70000000-0000-4000-8000-000000000004', 155.00, 239.00, 'https://mediamarkt.es/homara-ollas-005', true, now() - interval '9 hours'),
  ('90000000-0000-4000-8000-000000000011', '80000000-0000-4000-8000-000000000006', '70000000-0000-4000-8000-000000000002', 79.00, 109.00, 'https://ikea.com/es/p/homara-vajilla-006', true, now() - interval '8 hours'),
  ('90000000-0000-4000-8000-000000000012', '80000000-0000-4000-8000-000000000006', '70000000-0000-4000-8000-000000000005', 82.00, 119.00, 'https://carrefour.es/homara-vajilla-006', true, now() - interval '15 hours'),
  ('90000000-0000-4000-8000-000000000013', '80000000-0000-4000-8000-000000000007', '70000000-0000-4000-8000-000000000004', 399.00, 549.00, 'https://mediamarkt.es/homara-lavadora-007', true, now() - interval '4 hours'),
  ('90000000-0000-4000-8000-000000000014', '80000000-0000-4000-8000-000000000007', '70000000-0000-4000-8000-000000000001', 415.00, 569.00, 'https://amazon.es/dp/homara-lavadora-007', true, now() - interval '6 hours'),
  ('90000000-0000-4000-8000-000000000015', '80000000-0000-4000-8000-000000000008', '70000000-0000-4000-8000-000000000001', 279.00, 399.00, 'https://amazon.es/dp/homara-robot-008', true, now() - interval '3 hours'),
  ('90000000-0000-4000-8000-000000000016', '80000000-0000-4000-8000-000000000008', '70000000-0000-4000-8000-000000000004', 289.00, 429.00, 'https://mediamarkt.es/homara-robot-008', true, now() - interval '9 hours'),
  ('90000000-0000-4000-8000-000000000017', '80000000-0000-4000-8000-000000000009', '70000000-0000-4000-8000-000000000001', 169.00, 229.00, 'https://amazon.es/dp/homara-escoba-009', true, now() - interval '4 hours'),
  ('90000000-0000-4000-8000-000000000018', '80000000-0000-4000-8000-000000000009', '70000000-0000-4000-8000-000000000005', 174.00, 239.00, 'https://carrefour.es/homara-escoba-009', true, now() - interval '10 hours'),
  ('90000000-0000-4000-8000-000000000019', '80000000-0000-4000-8000-000000000010', '70000000-0000-4000-8000-000000000001', 129.00, 179.00, 'https://amazon.es/dp/homara-freidora-010', true, now() - interval '2 hours'),
  ('90000000-0000-4000-8000-000000000020', '80000000-0000-4000-8000-000000000010', '70000000-0000-4000-8000-000000000004', 134.00, 189.00, 'https://mediamarkt.es/homara-freidora-010', true, now() - interval '7 hours'),
  ('90000000-0000-4000-8000-000000000021', '80000000-0000-4000-8000-000000000011', '70000000-0000-4000-8000-000000000001', 189.00, 259.00, 'https://amazon.es/dp/homara-cafetera-011', true, now() - interval '6 hours'),
  ('90000000-0000-4000-8000-000000000022', '80000000-0000-4000-8000-000000000011', '70000000-0000-4000-8000-000000000003', 194.00, 269.00, 'https://leroymerlin.es/homara-cafetera-011', true, now() - interval '14 hours'),
  ('90000000-0000-4000-8000-000000000023', '80000000-0000-4000-8000-000000000012', '70000000-0000-4000-8000-000000000001', 99.00, 139.00, 'https://amazon.es/dp/homara-microondas-012', true, now() - interval '5 hours'),
  ('90000000-0000-4000-8000-000000000024', '80000000-0000-4000-8000-000000000012', '70000000-0000-4000-8000-000000000005', 104.00, 149.00, 'https://carrefour.es/homara-microondas-012', true, now() - interval '11 hours')
on conflict (id) do update
set
  product_id = excluded.product_id,
